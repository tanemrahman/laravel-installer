# Laravel Web Installer | A Web Installer [Package](https://packagist.org/packages/tanemrahman/laravel-installer)

[![Total Downloads](https://poser.pugx.org/tanemrahman/laravel-installer/d/total.svg)](https://packagist.org/packages/tanemrahman/laravel-installer)
[![Latest Stable Version](https://poser.pugx.org/tanemrahman/laravel-installer/v/stable.svg)](https://packagist.org/packages/tanemrahman/laravel-installer)
[![License](https://poser.pugx.org/tanemrahman/laravel-installer/license.svg)](https://packagist.org/packages/tanemrahman/laravel-installer)
...
```bash
    composer require tanemrahman/laravel-installer
```
...
```php
	'providers' => [
	    TanemRahman\LaravelInstaller\Providers\LaravelInstallerServiceProvider::class,
	];
```
...
* If you have any suggestions please let me know : https://github.com/TanemRahman/LaravelInstaller/pulls.
* Please help us provide more languages for this awesome package please send a pull request https://github.com/TanemRahman/LaravelInstaller/pulls.
